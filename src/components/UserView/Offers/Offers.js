...
function Offers() {
    const { data: adverts, isPending } = useFetch(process.env.REACT_APP_SERVER_URL + "/myadvertisements")
    ...
    return (
        <div className="offers">
                ...
                {adverts.advertisements.map(advert => (
                    <div className="advert-item" key={advert._id} onClick={() => showBuyersInterested(advert)}>
                        ...
                        <div className="advert-name">
                            <p><strong>{advert.property_details.property_title}</strong></p>
            ...
            <div className="interested-users">
                ...
                <div className="buyer-list">
                    {buyers && buyers.map(buyer => (
                        <div className="buyer-item" key={buyer._id} onClick={() => showBuyerChat(buyer)}>
            ...
            {buyer &&  <div className="buyer-contact">
