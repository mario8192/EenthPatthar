            ...
            <div className="container mt-5">
                <div className="row">
                    <div className="col-md-4">
                        {user &&
                            <div className="card" style={{ width: "18rem", height: "auto", textAlign: "center" }}>
                                <div className="card-body">
                                    ...
                                    <div className="card-text">
                                        ...
                                        <h6>Contact number: {user.mobile}</h6>
                                    </div>
                                </div>
                            </div>
                        }
                    ...
                    <div className="col-md-4">
                        <div className="row">
                            <div onClick={fetchmyAds} className="col">
                                <button className="btn btn-outline-primary">Show my Advertisements</button>
                            </div>
                            <div className="col-md-4" onClick={adformHandler}>
                                <button className="btn btn-outline-primary">Post an advertisement</button>
                            </div>
                        </div>
                        <div className="row">
                            {myAds && myAds.map((val) => {
                                                ...
                                                <div className="card-body">
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                            ...
                                                            <small><i className="fa fa-map-marker" aria-hidden="true"></i> {val.area}, {val.city}</small>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <h6 className="card-title">Posted on : {val.posted}</h6>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                            <h6 className="card-title">Intrested : {val.intrested}</h6>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <h6 className="card-title">Approved : {val.approve}</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
